    ...
    begin {
        ...
        if ($psversiontable.psversion.major -gt 2) {
            ...
            if ($Version) {
                $SelectProperty += 'Version'
            }
            if ($Vendor) {
                $SelectProperty += 'Vendor'
            }
            if ($SystemComponent) {
                $SelectProperty += 'SystemComponent'
            }
        }
    }
                            ...
                            if ($RegBase) {
                                ...
                                if ($CurrentRegKey) {
                                    $CurrentRegKey.GetSubKeyNames() | ForEach-Object {
                                        ...
                                        $SystemComponent = ($RegBase.OpenSubKey("$CurrentReg$_")).GetValue('SystemComponent')
                                        $Version = ($RegBase.OpenSubKey("$CurrentReg$_")).GetValue('DisplayVersion')
                                        $Vendor = ($RegBase.OpenSubKey("$CurrentReg$_")).GetValue('Publisher')
                                        ...
                                        $HashProperty.Version = $Version
                                        $HashProperty.Vendor = $Vendor
                                        $HashProperty.SystemComponent = $SystemComponent
                                        if ($DisplayRegPath) {
